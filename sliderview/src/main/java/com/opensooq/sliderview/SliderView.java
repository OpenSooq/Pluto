...
public class SliderView extends FrameLayout {
    ...
    public SliderView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.SliderViewStyle);
    ...
    public SliderView(@NonNull Context context,
        ...
        mAutoCycle = attributes.getBoolean(R.styleable.SliderView_auto_cycle, true);
        mIndicatorVisibility = attributes.getBoolean(R.styleable.SliderView_indicator_visibility,
                false);
        initScrollListener();
    ...
    static class IncomingHandler extends Handler {
        private final WeakReference<SliderView> mSliderWeakReference;

        IncomingHandler(SliderView sliderView) {
            mSliderWeakReference = new WeakReference<>(sliderView);
        }

        @Override
        public void handleMessage(Message msg) {
            SliderView sliderView = mSliderWeakReference.get();
            if (sliderView != null) {
